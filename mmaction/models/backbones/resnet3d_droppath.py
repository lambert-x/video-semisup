...
class ResNet3d_Droppath(nn.Module):
    """ResNet 3d backbone.
    ...
    def __init__(self,
        ...
        self.net_block_idx = 0
        self.net_num_blocks = sum(self.stage_blocks)
        self.res_layers = []
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            res_layer = self.make_res_layer(
                ...
                net_block_idx=self.net_block_idx,
                net_num_blocks=self.net_num_blocks,
    ...
    def make_res_layer(block,
        ...
        layers.append(
            block(
                ...
                act_cfg=act_cfg,
                with_cp=with_cp,
                drop_path=DropPath(drop_path_rate * net_block_idx / (net_num_blocks - 1)) \
                    if (drop_path_rate * net_block_idx / (net_num_blocks - 1) > 0. and
                        net_block_idx >= start_drop_idx) else nn.Identity(),
...
if mmdet_imported:
    MMDET_BACKBONES.register_module()(ResNet3d_Droppath)
