...
train_pipeline = [
    dict(type='SampleFrames_WithDiff', clip_len=8, frame_interval=8, num_clips=1),
    dict(type='RawFrameDecode_WithDiff'),
    ...
    dict(type='Normalize_Diff', **img_norm_cfg, raw_to_diff=False, redist_to_rgb=True),
