# model settings
model = dict(
    type='Semi_Crossclip_Recognizer3D',
    backbone=dict(
        type='ResNet3d',
        depth=18,
        pretrained=None,
    ...
    train_cfg=dict(
        ...
        temp_align_indices=None,
    ),
    test_cfg=dict(average_clips='score'))

# dataset settings
dataset_type = 'RawframeDataset'
dataset_type_labeled = 'RawframeDataset_Multiclip'
dataset_type_unlabeled = 'UnlabeledRawframeDataset_Multiclip'
...
train_pipeline = [
    ...
    dict(type='RawFrameDecode_Custom', extra_modalities=['flow_xym'], override_modality='empty',
         results_mapping={'imgs_flow_xym': 'imgs'}),
...
data = dict(
    ...
    train_unlabeled=dict(
        ...
        contrast_clip_num=1,
        collect_keys=['imgs_weak', 'imgs_strong', 'label_unlabeled']
    ),
    val=dict(
        type=dataset_type,
