...
model = dict(
    ...
    cls_head=dict(
        ...
        dropout_ratio=0.5,
        init_std=0.01),
    train_cfg=dict(warmup_epoch=30,
...
# ann_file_train_unlabeled = f'data/ucf101/videossl_splits/ucf101_train_{labeled_percentage}_percent_unlabeled_split_{split}_rawframes.txt'
...
log_level = 'INFO'
work_dir = f'./work_dirs/r3d_r18_8x8x1_180e_ucf101_rgb_all_{labeled_percentage}percent_warmup30_linearlr30/'
load_from = None
resume_from = None
workflow = [('train', 1)]
