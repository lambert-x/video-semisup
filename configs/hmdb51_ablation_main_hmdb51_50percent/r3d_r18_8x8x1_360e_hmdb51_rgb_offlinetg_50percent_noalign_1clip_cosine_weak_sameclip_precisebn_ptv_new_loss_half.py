...
model = dict(
    ...
    train_cfg=dict(
        ...
        crossclip_contrast_loss=['crossview_sameclip'],
...
ann_file_train_labeled = f'data/hmdb51/videossl_splits/hmdb51_train_{labeled_percentage}_percent_labeled_split_1_rawframes.txt'
...
precise_bn = dict(num_iters=120, interval=5,
